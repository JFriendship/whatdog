...
def get_hardcoded_dataset_labels():
    """
    Returns a hardcoded python dictionary that converts label values
    to the string they represent.
    If new categories are added to the training dataset, this will need to
    be updated.

    Returns:
        dict: A label mapping of integer prediction values to their corresponding string dog breed
    """
    return {
        0: "Chihuahua",
        1: "Japanese_spaniel",
